...
mysqli_query($connections, "UPDATE tbl_visualizationchart SET link='$new_link', detail='$new_detail' WHERE id='$link_id'");


echo "<script language='javascript'>alert('Link has been updated!')</script>"; //alert method 
echo "<script>window.location.href='../php/editvisualizationchart.php';</script>";
?>
