  ...
  <div id="webcrumbs"> 
    <div class="max-w-2xl mx-auto bg-neutral-50 shadow rounded-lg p-6">
        <header class="mb-6 text-center">
            <h1 class="text-3xl font-title text-primary">Frontend Tools
                <i class="fa fa-gears" aria-hidden="true"></i></h1>
            <p class="mt-2 text-lg">Best tools for Frontend development</p>
        </header>
