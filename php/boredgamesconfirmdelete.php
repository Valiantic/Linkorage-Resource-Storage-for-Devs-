...
$query_delete = mysqli_query($connections, "SELECT * FROM tbl_boredgames WHERE id = '$link_id' ");
...
<head>
    ...
    <title>Edit A.I Bored Games</title>
...
<body>
    ...
    <form class="inputing" method="POST" action="boredgamesdelete_now.php">
    ...
    <div class="max-w-md w-full bg-card shadow-lg rounded-lg p-6">
        ...
        <div class="flex flex-col space-y-4">
            ...
            <a class="nobtn" href='../php/editboredgames.php'>No</a>
