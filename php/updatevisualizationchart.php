...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_visualizationchart WHERE id='$link_id'"); // get id of a certain account
...
?>
    ...
    <form class="inputing" method="POST" action="updated_visualizationchart.php">
