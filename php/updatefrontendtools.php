...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_front_endtools WHERE id='$link_id'"); // get id of a certain account
...
<head>
    ...
    <title>Edit Front-End Tools</title>
...
?>
    ...
    <form class="inputing" method="POST" action="updated_frontendtools.php">
