  ...
  <div id="webcrumbs"> 
    <div class="max-w-2xl mx-auto bg-neutral-50 shadow rounded-lg p-6">
        <header class="mb-6 text-center">
            <h1 class="text-3xl font-title text-primary">A.I Helpers 
                <i class="fa fa-hand-paper-o" aria-hidden="true"></i></h1>
            <p class="mt-2 text-lg">Your go-to platform for AI tools and resources.</p>
        </header>
