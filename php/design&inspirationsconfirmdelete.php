...
$query_delete = mysqli_query($connections, "SELECT * FROM tbl_designinspirations WHERE id = '$link_id' ");
...
<body>
    ...
    <form class="inputing" method="POST" action="design&inspirationsdelete_now.php">
    ...
    <div class="max-w-md w-full bg-card shadow-lg rounded-lg p-6">
        ...
        <div class="flex flex-col space-y-4">
            ...
            <a class="nobtn" href='../php/editdesign&inspirations.php'>No</a>
