...
if ($link && $detail) {
  //  adding a user to the database 
   $query = mysqli_query($connections, "INSERT INTO tbl_front_endtools(link,detail) VALUES('$link','$detail')");

  // indicator that a new account is inserted using js 
  echo "<script language='javascript'>alert('New Link has been inserted!')</script>";
  echo "<script>window.location.href='editfrontendtools.php';</script>";
  }
